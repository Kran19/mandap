...
import { FactoryProvider, MiddlewareConsumer, ModuleMetadata } from '@nestjs/common';
 ...
 */
export interface Params<IM = IncomingMessage, SR = ServerResponse, CustomLevels extends string = never> {
    /**
     * Optional parameters for `pino-http` module
     * @see https://github.com/pinojs/pino-http#pinohttpopts-stream
     */
    pinoHttp?: Options<IM, SR, CustomLevels> | DestinationStream | [Options<IM, SR, CustomLevels>, DestinationStream];
    /**
...
export interface LoggerModuleAsyncParams<IM = IncomingMessage, SR = ServerResponse, CustomLevels extends string = never> extends Pick<ModuleMetadata, 'imports' | 'providers'>, Pick<FactoryProvider<Params<IM, SR, CustomLevels>>, 'useFactory' | 'inject'> {
}
