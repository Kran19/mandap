...
enum EditorMode {
  ...
  /// Tap canvas to place a manual support pole.
  addPole,
  ...
  /// Drag to create a flooring zone.
  addFlooring,

  /// Drag to create a stage zone.
  addStage,
}
...
extension EditorModeLabel on EditorMode {
  String get label => switch (this) {
    ...
    EditorMode.addPole => 'Add Pole',
    EditorMode.addEdge => 'Add Edge',
    EditorMode.delete => 'Delete',
    EditorMode.addFlooring => 'Add Flooring',
    EditorMode.addStage => 'Add Stage',
  };
  ...
  String get shortLabel => switch (this) {
    ...
    EditorMode.addPole => '+Pole',
    EditorMode.addEdge => '+Edge',
    EditorMode.delete => 'Del',
    EditorMode.addFlooring => '+Floor',
    EditorMode.addStage => '+Stage',
  };
}
