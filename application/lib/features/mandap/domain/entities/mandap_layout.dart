...
class MandapLayout {
  ...
  MandapLayout withNode(MandapNode node) {
    ...
    return MandapLayout(nodes: updated, edges: edges, zones: zones);
  }
  ...
  MandapLayout withoutNodeAndConnectedEdges(NodeId nodeId) {
    ...
    return MandapLayout(nodes: filteredNodes, edges: filteredEdges, zones: zones);
  }
  ...
  bool operator ==(Object other) =>
      ...
      (other is MandapLayout &&
          ...
          _listsEqual(zones, other.zones));

  @override
  int get hashCode =>
      Object.hash(Object.hashAll(nodes.entries), Object.hashAll(edges.entries), Object.hashAll(zones));
  ...
  static bool _listsEqual<T>(List<T> l1, List<T> l2) {
