...
class DragConstraintCalculator {
  ...
  /// Snaps a scalar value in feet to the nearest 0.5-ft increment.
  static double snapToHalfFoot(double feet) {
    return (feet * 2.0).round() / 2.0;
  }
  ...
  static EdgeDragResult calculateEdgeHandleDrag({
    ...
    // Snap distance to nearest 0.5 ft
    final snappedFeet = snapToHalfFoot(rawFeet);
  ...
  static NodeDragResult calculateNodeDrag({
    ...
    final snappedX = snapToHalfFoot(rawX);
    final snappedZ = snapToHalfFoot(rawZ);
